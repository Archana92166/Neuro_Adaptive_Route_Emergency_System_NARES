...
import { LoginForm } from "@/components/neuronav/login-form";
...
export default function LoginPage() {
    ...
    const handleLoginSuccess = () => {
        toast({
            ...
            description: "Welcome back to NeuroNav!",
        });
        router.push("/");
    }
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            if (!userDoc.exists()) {
                // Removed uid from newUserProfile as it's already the document ID
      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-lg">
            <CardHeader>
                ...
                <CardDescription>Access your NeuroNav account.</CardDescription>
            </CardHeader>
            <CardContent>
