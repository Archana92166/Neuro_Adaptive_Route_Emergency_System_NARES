...
export const SignUpCredentialsSchema = z.object({
    ...
    gender: z.enum(["Male", "Female", "Rather not say", ""]).default("Rather not say"),
...
export interface UserProfile {
    ...
    name: string;
    email: string;
    profession: "student" | "professional" | "other" | "unspecified"; // Added 'unspecified' default
    address?: string;
    gender?: 'Male' | 'Female' | 'Rather not say';
    age?: number | null;
    emergencyNumber?: string;
    neurodiversity?: string[];
    createdAt: Date; // Keep the creation timestamp
}